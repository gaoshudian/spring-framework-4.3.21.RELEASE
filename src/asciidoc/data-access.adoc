...
* __JdbcTemplate__ is the classic Spring JDBC approach and the most popular. This
  "lowest level" approach and all com.gao.servlet3.others2 use a JdbcTemplate under the covers.
...
upper case while com.gao.servlet3.others2 use lower case or use the case as specified.
...
databases return result sets during the JDBC results processing while com.gao.servlet3.others2 require an
...
in late 2015. We therefore recommend Hibernate 5.0 and higher from a 2016+ perspective.
====
